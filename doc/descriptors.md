# Support for Output Descriptors in Gyarabium Core

Since Gyarabium Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `grb1...` for mainnet or `tgrb1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Gyarabium's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Gyarabium Core wallets, a convenience function `combo` is
