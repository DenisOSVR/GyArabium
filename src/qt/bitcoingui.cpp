...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gyarabium: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a gyarabium: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Gyarabium command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Gyarabium network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
