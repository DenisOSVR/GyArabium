...
const char* BIP71_MIMETYPE_PAYMENT = "application/gyarabium-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/gyarabium-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/gyarabium-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start gyarabium: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("gyarabium://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'gyarabium://' is not a valid URI. Use 'gyarabium:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Gyarabium address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
