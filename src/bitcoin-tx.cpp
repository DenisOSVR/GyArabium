...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gyarabium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gyarabium-tx [options] <hex-tx> [commands]  Update hex-encoded gyarabium transaction\n" +
            "or:     gyarabium-tx [options] -create [commands]   Create hex-encoded gyarabium transaction\n" +
            "\n";
