...
{
    const char* pszTimestamp = "Prague Morning 31/Jan/2022 Hundreds of Czechs Protest Against COVID Curbs";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x7f7ff1efa3c43640a75c4976b7080cbcf64854465a2ee76582121391198d0a59");
        ...
        genesis = CreateGenesisBlock(1643649950, 2089031290, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7f7ff1efa3c43640a75c4976b7080cbcf64854465a2ee76582121391198d0a59"));
        assert(genesis.hashMerkleRoot == uint256S("0xf1481b2ccf8649e00b0716ec69953b1101e61e4c07ca544d281f4ff4db1d1e49"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x7f7ff1efa3c43640a75c4976b7080cbcf64854465a2ee76582121391198d0a59")},
            }
        };
