...
bech32_templates = [
  ...
  ('grb',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('grb',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('grb',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tgrb',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tgrb',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tgrb',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rgrb',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rgrb',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rgrb', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tgrb',  17, 32, False, False, False),
  ('rgrb',  3,  1, False, False, False),
  ('grb',   15, 41, False, False, False),
  ('tgrb',  0, 16, False, False, False),
  ('rgrb',  0, 32, True,  False, False),
  ('grb',   0, 16, True,  False, False),
  ('tgrb',  0, 32, False, True,  False),
  ('rgrb',  0, 20, False, False, True)
]
