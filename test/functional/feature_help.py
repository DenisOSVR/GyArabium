...
"""Verify that starting gyarabium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gyarabium with -h for help text")
        ...
        self.log.info("Start gyarabium with -version for version information")
        ...
        self.log.info("Start gyarabiumd with -fakearg to make sure it does not start")
